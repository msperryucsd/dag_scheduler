...
from dag_parallelizer.schedulers.mta.order_nodes_by_weight_no_sort import order_nodes_by_weight_before
from dag_parallelizer.schedulers.scheduler_functions import schedule_pt2pt_comm, schedule_operation, get_pt2pts_key, add_to_schedule, add_to_estimated_timeline

from dag_parallelizer.utils import draw

class MTB_ETA_ARB(Algorithm):
    ...
    def schedule(self, ccl_graph):
        ...
        order_nodes_by_weight_before(o_sdag)
